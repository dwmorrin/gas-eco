...
function Booking_(bookingData) {
  ...
  this.startTime = DateUtils.getFormattedDate(
    bookingData[this.dataIndex.START_TIME]
  );
  this.endTime = DateUtils.getFormattedDate(
    bookingData[this.dataIndex.END_TIME]
  );
