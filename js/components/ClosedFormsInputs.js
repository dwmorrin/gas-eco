...
export default function ClosedFormsInputs({
  closedFormsQuery = {},
  onSubmit = () => undefined,
}) {
  ...
  const queryInputs = createElement("form", {
    ...
    children: [
      ...
      matchItemsRadio("Form has all of the items", "all", matchItems === "all"),
      matchItemsRadio("Form has any of the items", "any", matchItems === "any"),
      ...[
