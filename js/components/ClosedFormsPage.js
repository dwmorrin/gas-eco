import ClosedFormsTable from "./ClosedFormsTable";
import ClosedFormsInputs from "./ClosedFormsInputs";
import { createElement, getRadioValue, page, update } from "../HTML";
...
export default function ClosedFormsPage({
  ...
  function onSubmit(form) {
    ...
    queryCount.textContent = length == 1 ? `${length} form` : `${length} forms`;
